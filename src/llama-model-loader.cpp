...
static std::string llama_model_ftype_name(llama_ftype ftype) {
    ...
    switch (ftype) {
        ...
        case LLAMA_FTYPE_MOSTLY_Q1_SYM32K:  return "Q1_SYM32K";
        case LLAMA_FTYPE_MOSTLY_Q4_SYM16K:  return "Q4_SYM16K";
        case LLAMA_FTYPE_MOSTLY_Q2_SYM32K4: return "Q2_SYM32K4";
...
llama_model_loader::llama_model_loader(
    ...
    // TODO: make optional
    {
        ...
        switch (type_max) {
            ...
            case GGML_TYPE_Q1_SYM32K:  ftype = LLAMA_FTYPE_MOSTLY_Q1_SYM32K;  break;
            case GGML_TYPE_Q4_SYM16K:  ftype = LLAMA_FTYPE_MOSTLY_Q4_SYM16K;  break;
            case GGML_TYPE_Q2_SYM32K4: ftype = LLAMA_FTYPE_MOSTLY_Q2_SYM32K4; break;
            default:
                {
