...
ggml_metal_device_t ggml_metal_device_init(int device) {
    ...
    if (dev->mtl_device == nil) {
        ...
        if (dev->mtl_device) {
            ...
            if (getenv("GGML_METAL_MAX_BUFFER_MB")) { // TEST HOOK: emulate iOS maxBufferLength caps
                dev->props.max_buffer_size = MIN(dev->props.max_buffer_size, (size_t) atoi(getenv("GGML_METAL_MAX_BUFFER_MB")) * 1024ull * 1024ull);
            }
