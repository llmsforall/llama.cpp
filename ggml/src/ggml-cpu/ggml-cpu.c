...
static const struct ggml_type_traits_cpu type_traits_cpu[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_Q1_AFFINE] = {
        .from_float               = quantize_row_q1_affine,
        .vec_dot                  = ggml_vec_dot_q1_affine_f32,
        .vec_dot_type             = GGML_TYPE_F32,
        .nrows                    = 1,
    },
    [GGML_TYPE_Q1_SYM16] = {
        .from_float               = quantize_row_block_q1_sym16,
        .vec_dot                  = ggml_vec_dot_q1_sym16_f32,
        .vec_dot_type             = GGML_TYPE_F32,
        .nrows                    = 1,
    },
    [GGML_TYPE_Q1_SYM64] = {
        .from_float               = quantize_row_block_q1_sym64,
        .vec_dot                  = ggml_vec_dot_q1_sym64_f32,
        .vec_dot_type             = GGML_TYPE_F32,
        .nrows                    = 1,
    },
    [GGML_TYPE_Q2_SYM16] = {
        .from_float               = quantize_row_block_q2_sym16,
        .vec_dot                  = ggml_vec_dot_q2_sym16_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
    [GGML_TYPE_Q4_SYM16] = {
        .from_float               = quantize_row_q4_sym16,
        .vec_dot                  = ggml_vec_dot_q4_sym16_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
    [GGML_TYPE_Q2_SYM32K4] = {
        .from_float               = quantize_row_q2_sym32k4,
        .vec_dot                  = ggml_vec_dot_q2_sym32k4_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
    [GGML_TYPE_QT_MS32K4] = {
        .from_float               = quantize_row_qt_ms32k4,
        .vec_dot                  = ggml_vec_dot_qt_ms32k4_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
    [GGML_TYPE_Q1_SYM32K] = {
        .from_float               = quantize_row_q1_sym32k,
        .vec_dot                  = ggml_vec_dot_q1_sym32k_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
    [GGML_TYPE_Q4_SYM16K] = {
        .from_float               = quantize_row_q4_sym16k,
        .vec_dot                  = ggml_vec_dot_q4_sym16k_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
    [GGML_TYPE_Q4_0] = {
