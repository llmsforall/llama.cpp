...
GGML_API void quantize_row_q1_affine_ref(const float * GGML_RESTRICT x, block_q1_affine * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_row_block_q1_sym16_ref(const float * GGML_RESTRICT x, block_q1_sym16 * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_row_block_q1_sym64_ref(const float * GGML_RESTRICT x, block_q1_sym64 * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_row_block_q2_sym16_ref(const float * GGML_RESTRICT x, block_q2_sym16 * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_row_q4_sym16_ref(const float * GGML_RESTRICT x, block_q4_sym16 * GGML_RESTRICT y, int64_t k);
...
GGML_API void dequantize_row_q1_affine(const block_q1_affine * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API void dequantize_row_block_q1_sym16(const block_q1_sym16 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API void dequantize_row_block_q1_sym64(const block_q1_sym64 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API void dequantize_row_block_q2_sym16(const block_q2_sym16 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API void dequantize_row_q4_sym16(const block_q4_sym16 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API void dequantize_row_q1_sym32k(const block_q1_sym32k * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_row_q1_sym32k_ref(const float * GGML_RESTRICT x, block_q1_sym32k * GGML_RESTRICT y, int64_t k);
GGML_API void dequantize_row_q2_sym32k4(const block_q2_sym32k4 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_row_q2_sym32k4_ref(const float * GGML_RESTRICT x, block_q2_sym32k4 * GGML_RESTRICT y, int64_t k);
GGML_API void dequantize_row_q4_sym16k(const block_q4_sym16k * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_row_q4_sym16k_ref(const float * GGML_RESTRICT x, block_q4_sym16k * GGML_RESTRICT y, int64_t k);
...
GGML_API size_t quantize_q1_affine(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_block_q1_sym16(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_block_q1_sym64(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_block_q2_sym16(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_q4_sym16(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_q1_sym32k(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_q2_sym32k4(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);

GGML_API void dequantize_row_qt_ms32k4(const block_qt_ms32k4 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_row_qt_ms32k4_ref(const float * GGML_RESTRICT x, block_qt_ms32k4 * GGML_RESTRICT y, int64_t k);
GGML_API size_t quantize_qt_ms32k4(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_q4_sym16k(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
