...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_Q1_AFFINE] = {
        .type_name                = "q1_affine",
        .blck_size                = QK1_AFFINE,
        .type_size                = sizeof(block_q1_affine),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q1_affine,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q1_affine_ref,
    },
    [GGML_TYPE_Q1_SYM16] = {
        .type_name                = "q1_sym16",
        .blck_size                = QK1_SYM16,
        .type_size                = sizeof(block_q1_sym16),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_block_q1_sym16,
        .from_float_ref           = (ggml_from_float_t) quantize_row_block_q1_sym16_ref,
    },
    [GGML_TYPE_Q1_SYM64] = {
        .type_name                = "q1_sym64",
        .blck_size                = QK1_SYM64,
        .type_size                = sizeof(block_q1_sym64),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_block_q1_sym64,
        .from_float_ref           = (ggml_from_float_t) quantize_row_block_q1_sym64_ref,
    },
    [GGML_TYPE_Q2_SYM16] = {
        .type_name                = "q2_sym16",
        .blck_size                = QK2_SYM16,
        .type_size                = sizeof(block_q2_sym16),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_block_q2_sym16,
        .from_float_ref           = (ggml_from_float_t) quantize_row_block_q2_sym16_ref,
    },
    [GGML_TYPE_Q4_SYM16] = {
        .type_name                = "q4_sym16",
        .blck_size                = QK4_SYM16,
        .type_size                = sizeof(block_q4_sym16),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q4_sym16,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q4_sym16_ref,
    },
    [GGML_TYPE_Q1_SYM32K] = {
        .type_name                = "q1_sym32k",
        .blck_size                = QK1_SYM32K,
        .type_size                = sizeof(block_q1_sym32k),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q1_sym32k,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q1_sym32k_ref,
    },
    [GGML_TYPE_Q2_SYM32K4] = {
        .type_name                = "q2_sym32k4",
        .blck_size                = QK2_SYM32K,
        .type_size                = sizeof(block_q2_sym32k4),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q2_sym32k4,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q2_sym32k4_ref,
    },
    [GGML_TYPE_QT_MS32K4] = {
        .type_name                = "qt_ms32k4",
        .blck_size                = QKT_MS32K,
        .type_size                = sizeof(block_qt_ms32k4),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_qt_ms32k4,
        .from_float_ref           = (ggml_from_float_t) quantize_row_qt_ms32k4_ref,
    },
    [GGML_TYPE_Q4_SYM16K] = {
        .type_name                = "q4_sym16k",
        .blck_size                = QK4_SYM16K,
        .type_size                = sizeof(block_q4_sym16k),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q4_sym16k,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q4_sym16k_ref,
    },
    [GGML_TYPE_Q4_0] = {
        .type_name                = "q4_0",
        .blck_size                = QK4_0,
...
size_t ggml_quantize_chunk(
    ...
    switch (type) {
        ...
        case GGML_TYPE_Q1_AFFINE: result = quantize_q1_affine(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_Q1_SYM16: result = quantize_block_q1_sym16(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_Q1_SYM64: result = quantize_block_q1_sym64(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_Q2_SYM16: result = quantize_block_q2_sym16(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_Q4_SYM16: result = quantize_q4_sym16(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_Q2_SYM32K4: result = quantize_q2_sym32k4(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_QT_MS32K4: result = quantize_qt_ms32k4(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_Q1_SYM32K: result = quantize_q1_sym32k(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_Q4_SYM16K: result = quantize_q4_sym16k(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
